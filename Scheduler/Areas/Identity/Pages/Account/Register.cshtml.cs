...
namespace Scheduler.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //Lowercase for email and username. TitleCase for first and last names.
                TextInfo caseSwitch = new CultureInfo("en-US", false).TextInfo;
                var user = new SchedulerUser 
                { 
                    UserName = Input.Email.ToLower(), 
                    Email = Input.Email.ToLower(), 
                    FirstName = caseSwitch.ToTitleCase(Input.FirstName.ToLower()), 
                    LastName = caseSwitch.ToTitleCase(Input.LastName.ToLower()) 
                };
